...
#'
sig_visualise_bootstraps <- function(bootstraps, min_contribution_threshold = 0.05, pvalue = 0.05) {
  ...
  plot <- boxplotstats::plot_boxplot_stats(
    ...
    ggplot2::geom_vline(xintercept = min_contribution_threshold, linetype = "longdash", colour = "red") +
