...
```{r minified, fig.height=3, fig.width=10}
...
```{r, donut_model, fig.height=4, fig.width=10}
model = c('SBS2' = 0.6, 'SBS13' = 0.2)
sig_visualise_model_donut(model, palette = c(SBS2="#E72826", SBS13="black", "Unexplained" = "grey90"))
```
